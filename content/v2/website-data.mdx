...
GET from url : `https://umami.mydomain.com/api/websites/86d4095c-a2a8-4fc8-9521-103e858e2b41/stats?start_at=1656679719687&end_at=1656766119687`
...
- `x`: Nuber of unique visitors within the last 5 minutes
...
URL: `https://umami.mydomain.com/api/websites/86d4095c-a2a8-4fc8-9521-103e858e2b41/metrics?type=event&startAt=1681362000000&endAt=1681448399999&url=%2Fdocs%2Fgetting-started`
...
- `subdivision1`: (optional)
- `subdivision2`: (optional)
...
URL: `https://umami.mydomain.com/api/websites/1/stats?start_at=1656679719687&end_at=1656766119687`

...
Go into your running docker container. Please use your real container name. You can find the name by the output of `docker ps`.
...
When the migration is run successfully, it should like like this:

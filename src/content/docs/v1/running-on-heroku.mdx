...
1. You will need to set up the database tables by following the **Create database tables** section of the [Install](/docs/v1/install) docs.
...
1. Follow the **Getting started** guide starting from the [Login](/docs/v1/login) step.

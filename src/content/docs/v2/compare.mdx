...
<img src="https://static.umami.dev/website/images/docs/v2/website-navbar.png" />
...
<img src="https://static.umami.dev/website/images/docs/v2/compare-graph.png" />

Compare individual metric stats. A performance indicator will be displayed if values match between the two periods.

<img src="https://static.umami.dev/website/images/docs/v2/compare-metrics.png" />

...
<img src="https://static.umami.dev/website/images/docs/v1/header.png" />

Then navigate to **Websites** and click on the **Edit** button next to your website.

<img src="https://static.umami.dev/website/images/docs/v1/edit-website.png" />

Check the **Enable share URL** checkbox and click **Save**.

<img src="https://static.umami.dev/website/images/docs/v1/edit-website-form.png" />

Then click the **Share URL** button next to your website.

<img src="https://static.umami.dev/website/images/docs/v1/share-url.png" />

The form that pops up will show you the URL.

<img src="https://static.umami.dev/website/images/docs/v1/share-url-form.png" />

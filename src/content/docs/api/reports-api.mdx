...
[
    {
        "url_query": "ref%3Dumami-email-header&sourcegmail&ust",
        "num": 1
    },
    {
        "url_query": "utm_campaign=xxxxxxx&utm_medium=email&utm_source=xxxxxxx",
        "num": 1
    },
    {
        "url_query": "utm_source=xxxxxx&utm_medium=outbound-email&utm_campaign=website&utm_content=website-email",
        "num": 6
    },
]
```

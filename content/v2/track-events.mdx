...
```
data-umami-event="Cart form"
data-umami-event-name="umami"
data-umami-event-id="123"
```

The additonal properties will result in `{ name: 'umami', id: '123' }` being recorded with the `Cart form` event name.

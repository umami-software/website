...
database, you can follow the [Running on DigitalOcean](/docs/v1/running-on-digitalocean) guide to get a database up and running. You
can also check out the **Managed databases** section under [Hosting](/docs/v1/hosting).
...
7. Follow the **Getting started** guide starting from the [Login](/docs/v1/login) step and be sure to change the default password.

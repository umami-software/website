...
In Umami Cloud, there is now a transfer website feature that lets you tranfer a website between your
...
The new teams feature is available to all users now in [Umami Cloud](https://cloud.umami.is?ref=blog). It will be available to self-host users in the next release
of Umami v2.10.0.

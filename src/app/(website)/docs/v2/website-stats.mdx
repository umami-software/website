...
- `minute`: Up to 60 minutes using the ‘minute’ unit.
- `hour`: Up to 48 hours using the ‘hour’ unit.
- `day`: Up to 12 months using the day unit'
- `month`: Up to 2 years using the ‘month’ unit'
- `year`: No limit.

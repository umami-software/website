...
The report works by choosing a Viewed page or Triggered event you want to track attribution for and displays referrer, paid ads, and UTM data through a specific attribution model.

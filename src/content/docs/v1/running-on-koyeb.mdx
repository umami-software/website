...
In this guide, you need to have a PostgreSQL database server running and accepting remote connections. If you do not already have a database, you can check out the **Managed database** section under [Hosting](/docs/v1/hosting).

> You will need to set up the database tables by following the **Create database tables** section of the [Install](/docs/v1/install) docs.
...
Open the URL to access Umami and follow the **Getting started** guide starting from the [Login](/docs/v1/login) step.

...
1. Add a second variable called `PORT`, set its value to a valid port number (eg: `3000`). Click **Add**.
1. Add a third variable called `DATABASE_TYPE`, set its value to `postgres`. Click **Add**.
1. Add a fourth variable called `HOSTNAME`, set its value to `0.0.0.0`. Click **Add**.
1. Click **Deploy**.

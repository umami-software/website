...
NOTE: do not forget to select the correct docker image according to your database. Usually the MySQL images prefixed with `mysql_` and PostgreSQL images prefixed with `postgresql_`.

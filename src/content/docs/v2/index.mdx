...
1. [Install the application](/docs/v2/install)
1. [Log into the application](/docs/v2/login)
1. [Add a website](/docs/v2/add-a-website)
1. [Add the tracking code into your website HTML](/docs/v2/collect-data)

## Hosting

If you are unfamiliar with running your own servers, check out the [Hosting](/docs/v2/guides/hosting) section to get a quick overview.

There are also many services that will run Umami. See the [Guides](/docs/v2/guides/hosting) section.
...
Yes, please see [Track Events](/docs/v2/track-events).

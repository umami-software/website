...
You do not need the `.js` extension. It can be any path you choose, and it wont affect the correct load and execution of the script. However, be sure to use the correct path to fetch your script, to avoid 404 errors. Some examples:

...
5. You can create the tables by using pgsql or by copying and pasting the content of the [`sql/schema.postgresql.sql`](https://github.com/umami-software/umami/blob/master/sql/schema.postgresql.sql) file into the Supabase Dashboard SQL editor.

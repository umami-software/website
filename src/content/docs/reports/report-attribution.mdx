...
Umami Attribution helps track the effectiveness of marketing channels, measure campaign performance, and identify which sources drive the most valuable traffic.
...
- `Revenue Mode`: (optional) Use attribution metrics instead of visitors (Only enabled if revenue data is configured [here](https://umami.is/docs/reports/report-attribution#configuring-attribution)).
